 ...
 */
class CreateCustomerToggleAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'is_pending');
    ...
    {
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $eavSetup->removeAttribute(\Magento\Customer\Model\Customer::ENTITY, 'is_pending');
